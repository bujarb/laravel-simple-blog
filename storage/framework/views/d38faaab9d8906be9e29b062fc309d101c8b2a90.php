  ...
  <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li><a href="<?php echo e(route('blog.index')); ?>">Blog <span class="sr-only">(current)</span></a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?php echo e(route('user.show',Auth::user()->id)); ?>">My Profile</a></li>
        ...
        <?php else: ?>
          <?php if(Route::currentRouteName() != 'login'): ?>
            <a href="<?php echo e(route('login')); ?>" class="btn btn-primary from-right">Login</a>
          <?php endif; ?>
        <?php endif; ?>
      </ul>
    </div><!-- /.navbar-collapse -->
